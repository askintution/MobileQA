...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_file', type=str, default='squad-style-data/cmrc2018_train.json')
    parser.add_argument('--dev_file', type=str, default='squad-style-data/cmrc2018_dev.json')
